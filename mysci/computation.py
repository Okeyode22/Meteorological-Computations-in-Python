...
def estimate_windchill(t, v):
    ...
    NOTE: This computation is valid only for temperatures between -45F and
    +45F and for wind speeds between 3mph and 60mph.
...
def compute_dewpoint(t, h):
    ...
    tempC = (t -32) * 5 / 9 # Convert temperature from degF to degC
    rh = h / 100
