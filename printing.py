def print_comparison(name, dates, times, original_data, computed_data):
    """
    This function print a comparison of two times series (original and computed) of data
    
    Parameters:
        name: A string name for the data being compared (Display limited to 9
        characters in length)
        dates: List of strings representing the dates for each data
        times: List of strings representing the of the day for each data
